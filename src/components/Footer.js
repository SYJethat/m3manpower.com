...
<div className="relative">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition">Job Openings</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition">Blue & White Collar Staffing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Contract & Permanent Recruitment</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Bulk Hiring & Campus Drives</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Payroll & Compliance Support</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Logistics & Warehouse Staffing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition">Industry-Specific Solutions</a></li>
            </ul>
          </div>
